...
from general.views.review_view import SubmitReviewView, review_confirmation
...
urlpatterns = [
    ...
    path('general/review_confirmation/<int:restaurant_id>/', review_confirmation, name="review_confirmation"), 
