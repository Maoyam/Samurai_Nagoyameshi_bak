...
urlpatterns = [
    ...
    path('general/filter/genre/<str:genre>/', GenreFilterView.as_view(), name="shop_list_genre"),
    path('general/filter/area/<str:area>/', AreaFilterView.as_view(), name="shop_list_filter"),
